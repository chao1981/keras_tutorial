...
from keras.applications.imagenet_utils import decode_predictions,CLASS_INDEX


def tensor_summary(tensor):
  """Display shape, min, and max values of a tensor."""
  print("{} shape: {}  min: {}  max: {}".format(tensor,tensor.shape, tensor.min(), tensor.max()))
...
# Display the top 10 classes
print("predictions",decode_predictions(predictions, top=10)[0])
